...
/*   Updated: 2024/12/15 07:28:47 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	uint_printf(va_list args, printf_form *form_found,
			char *flags, char **str);
size_t	uint_printf_logic0(printf_form *form_found, char *flags,
			unsigned int ux, size_t uint_len);
size_t	uint_printf_logic(printf_form *form_found, char *flags,
			unsigned int ux, size_t uint_len);
size_t	uint_printf_logic_prefix(printf_form *form_found, char *flags,
			size_t uint_len);
