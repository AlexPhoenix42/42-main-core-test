...
/*   Updated: 2024/12/15 07:09:49 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_printf_form(printf_form *form_found, char *is_found);
void	get_form(char *str, char *flags, char *forms,
			printf_form *form_found);
void	get_form_logic(char *str, char *flags,
			char *forms, printf_form *form_found);
void	check_form_logic(size_t i, char *str,
			char *flags, printf_form *form_found);
...
void	get_form(char *str, char *flags, char *forms, printf_form *form_found)
{
