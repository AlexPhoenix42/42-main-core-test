...
/*   Updated: 2024/12/14 16:51:36 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	hex_printf_prefix_cnd(printf_form *form_found, size_t hex_len,
...
size_t	hex_printf_logic_cnd(printf_form *form_found, size_t hex_len,
			char *flags, unsigned int ux)
{
	size_t	j;
	size_t	len_r;
...
size_t	int_printf_logic_prefix0_cnd(printf_form *form_found, size_t int_len,
							char *flags, int x)
{
	size_t	j;
	size_t	len_r;
