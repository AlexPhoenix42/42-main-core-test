...
/*   Updated: 2024/12/15 07:26:36 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	ptr_printf(va_list args, printf_form *form_found,
			char *flags, char **str);
size_t	ptr_printf_logic(void *p, printf_form *form_found,
			char *flags, size_t hex_len);
size_t	ptr_printf_logic_prefix(void *p, printf_form *form_found,
			char *flags, size_t hex_len);
